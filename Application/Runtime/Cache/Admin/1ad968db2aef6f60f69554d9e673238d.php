...
<form action="<?php echo U('Index/handle_news');?>" method="post">
    选择标题：<select name="type" id="" onchange="change(this.value)">
        <option value="1">媒体新闻</option>
        <option value="2">项目新闻</option>
    </select>
    <br/>
    标题：<input type="text" name="title" required width="1000px" value="<?php echo ($news["title"]); ?>">
